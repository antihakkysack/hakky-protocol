...
export function createCanonicalMintProofV2() {
  return {
    ...
    observation: {
      ...
      creationTransactionSha256: HASHES.transaction,
      metadataCreateCpiSha256: HASHES.launch,
      creationExecutionSha256: HASHES.platformConfigCreation,
    ...
    checks: {
      ...
      sourcePinnedAccountMetas: true,
      atomicImmutableMetadata: true,
      ...
      immutableMetadataPostState: true,
