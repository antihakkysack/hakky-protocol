...
test("cross-checks every published launch fact against its canonical proof", () => {
  const cases = [
    ...
    ["metadataUri", (_mint, launch) => { launch.metadataUri = "https://cdn.hakky.xyz/different-metadata.json"; }],
    ["metadataImage", (_mint, launch) => { launch.metadataImage = "https://cdn.hakky.xyz/different-token.png"; }],
